(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@mapbox/tilebelt')) :
    typeof define === 'function' && define.amd ? define(['@mapbox/tilebelt'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, (global[""] = global[""] || {}, global[""]["/dist/mapbox-gl-ogc-feature-collection"] = global[""]["/dist/mapbox-gl-ogc-feature-collection"] || {}, global[""]["/dist/mapbox-gl-ogc-feature-collection"].js = factory(global.tilebelt)));
})(this, (function (tilebelt) { 'use strict';
    ...
    class OGCFeatureCollection {
        ...
        async _findAndMapData() {
            ...
            const primaryTile = tilebelt__default["default"].bboxToTile([bounds[0][0], bounds[0][1], bounds[1][0], bounds[1][1]]);
            ...
            if (primaryTile[2] < zoomLevel) {
                let candidateTiles = tilebelt__default["default"].getChildren(primaryTile);
                let minZoomOfCandidates = candidateTiles[0][2];
                while (minZoomOfCandidates < zoomLevel) {
                    const newCandidateTiles = [];
                    candidateTiles.forEach(t => newCandidateTiles.push(...tilebelt__default["default"].getChildren(t)));
            ...
            for (let index = 0; index < tilesToRequest.length; index++) {
                const quadKey = tilebelt__default["default"].tileToQuadkey(tilesToRequest[index]);
        ...
        _getTile(tile) {
            const tileBounds = tilebelt__default["default"].tileToBBOX(tile);
        ...
        _doesTileOverlapBbox(tile, bbox) {
            const tileBounds = tile.length === 4 ? tile : tilebelt__default["default"].tileToBBOX(tile);
